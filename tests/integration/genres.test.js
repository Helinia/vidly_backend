...
describe('/api/genres', ()=>{
    ...
    describe('GET /:id',  () =>{
        it('should return genre with the specified ID', async()=>{
            // await Genre.collection.insertMany([
            //     { name: 'genre1'},
            //     { name: 'genre2'}
            // ]);
            // const genre = await Genre.find({name: 'genre1'}).select('name _id');
...
describe('POST /', ()=>{
        ...
        //Approach: define the happy path, and then in each test, we change
